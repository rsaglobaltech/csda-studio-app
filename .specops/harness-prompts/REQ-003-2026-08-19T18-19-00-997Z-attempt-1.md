...
You are a coding agent working inside a spec-driven project. Implement exactly one requirement — **REQ-003** — following the project's existing conventions. Do not touch unrelated files.
## Requirement facts

- Requirement: REQ-003
- Scenario ID: SCN-003
- plan category: NEEDS_EVERYTHING
- Feature file: `features/pack-browsing/browse_requirements.feature`
- Test artifact (write this first — TDD): browse_requirements.steps
- Production artifact: Requirements list view
- Current status: Draft

## Gherkin scenario (features/pack-browsing/browse_requirements.feature)
